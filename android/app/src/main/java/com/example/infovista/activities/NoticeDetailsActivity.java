...
public class NoticeDetailsActivity extends AppCompatActivity {
    ...
    private void publishNotice() {
        ...
        try {
            ...
            okhttp3.RequestBody isMutedPart = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"), String.valueOf(notice.isMuted()));
            ...
            Call<ApiResponse<Notice>> call = ApiClient.getApiService().updateNotice(
                    authToken, notice.getId(), titlePart, descriptionPart, priorityPart, categoryPart, durationPart, isActivePart, isMutedPart, scheduledAtPart, expiresAtPart, null
            );
